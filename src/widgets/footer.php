<footer>
    <div class="footer-container">
        <div class="footer-box">
            <img src="src/assets/multimedia/logo-white.png" alt="">
            
            <ul>
                <li><p><i class="fas fa-map-marked-alt"></i> <b>Dirección: </b>Homero 229 Int. MS-4, Del. Miguel Hidalgo, CP. 11570, Ciudad de México</p></li>
                <li><a href="tel:5535225897"><i class="fas fa-phone"></i> <b>Teléfono: </b>55 3522 5897</a></li>
                <li><a href="mailto:contacto@decmarketing.mx"><i class="fas fa-envelope"></i> <b>Correo: </b>contacto@decmarketing.mx</a></li>
            </ul>
        </div>
        <div class="footer-box">
        ...
        <div class="footer-box">
            ...
            <ul>
                <li><a href="https://www.decmarketing.mx/k2-categories/la-importancia-de-una-landing-page-en-tu-estrategia-de-marketing"><i class="fas fa-chevron-right"></i> IMPORTANCÍA DE UNA LANDING PAGE</a></li>
                <li><a href="https://www.decmarketing.mx/k2-categories/para-que-sirve-un-chatbot"><i class="fas fa-chevron-right"></i> ¿POR QUÉ DEBO TENER UN CHAT BOT EN MI PÁGINA WEB?</a></li>
